...
class WebExtensionLoggerHelper implements ILoggerHelper
{
	...
	{
		(browser.extension.getBackgroundPage() as any)[WebExtensionLoggerHelper.ENABLE_INFO_LOGGING_NAME] = value;
	}

	private static getGlobalEnableInfoLogging(): boolean
	{
		return (browser.extension.getBackgroundPage() as any)[WebExtensionLoggerHelper.ENABLE_INFO_LOGGING_NAME];
	}
	...
	{
		return WebExtensionLoggerHelper.getGlobalEnableInfoLogging();
	}
}
